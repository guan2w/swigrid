...
1. `ios-native/scripts/verify.sh`
2. `ios-native/scripts/verify-xcode-backend.sh`
3. `ios-native/scripts/verify-ios-app.sh`
4. `ios-native/scripts/verify-ios-ui-tests.sh`
