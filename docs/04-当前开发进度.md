...
- 完成：将壳工程入口迁移到 `ios-native/ios-app/swigrid/App/SwiftGridShellApp.swift`，资源迁移到 `ios-native/ios-app/swigrid/Resources/Assets.xcassets`；UI Test 文件重命名为 `SchulteGridUITests.swift` 并更新脚本测试选择器。
